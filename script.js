...
let friendName = "Tricia";

console.log(food, drink, firstName, friendName);

//Question: Name a reason why you would use const instead of let.
//Answer: If I dont want to change the name of the variable.
...
console.log(
  `${firstName} and ${friendName} love ${drink} and will have ${food} for lunch!`
);
...
//Answer: console.log('firstName' + 'and' + 'friendName' + 'love' + 'drink' + + 'and will have' + 'food' + 'for lunch!');
console.log(`-------------------------- 
    Question 2a: Oh no`);
...
//Answer: The variable I'm trying to change is a const and cannot be changed
 ...
 * ↓ YOUR CODE HERE ↓ */
const lunchTime = (foodChoices, drinkChoices) => {
  return `${friendName} and ${firstName} love ${drinkChoices} and will have ${foodChoices} for lunch!`;
};
console.log(lunchTime("Pizza", "Water"));
//Question: What would your function look like if we were using the old way of creating a function?
/*Answer: function lunchTime (foodChoices, drinkChoices){
return 'firstName' + 'and' + 'friendName' + 'love' + 'drink' + + 'and will have' + 'food' + 'for lunch!';}*/
...
const foodForTodayAndTomorrow = (
  ...
  return `${callbackFunction} Tomorrow we want ${tomorrowsFoodChoice} and ${tomorrowsFoodChoice}.`;
};
console.log(
  foodForTodayAndTomorrow(
    "Pasta",
    "Iced Tea",
    lunchTime("vegan nuggets", "Pepsi")
  )
);
